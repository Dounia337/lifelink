...
-- Users (Donors, Hospital Staff, Health Workers, Admins)
CREATE TABLE users (
...
-- Donor Matches (linking requests to donors)
...
-- Blood Type Compatibility Table (static reference)
...
INSERT INTO donor_profiles (user_id, blood_type, blood_type_verified, verified_by, date_of_birth, gender, weight_kg, is_eligible, availability_status, last_donation_date, total_donations) VALUES
...
INSERT INTO hospitals (user_id, hospital_name, registration_number, hospital_type, address, city, region, latitude, longitude, is_approved, approved_by) VALUES
...
INSERT INTO blood_requests (hospital_id, requested_by, patient_name, blood_type, units_needed, urgency, reason, location, latitude, longitude, status) VALUES
...
INSERT INTO donation_records (donor_id, hospital_id, blood_type, units_donated, donation_date, verified_by) VALUES
